...
public class AttributeRuntimeInvisibleAnnotations extends DefaultAttribute {
	
	private Annotation[] annotations;
	
	public AttributeRuntimeInvisibleAnnotations(ClassFile classFile, int nameIndex, byte[] info) throws IOException {
	...
	@Deprecated
	public AttributeRuntimeInvisibleAnnotations(ClassFile classFile, ConstantPoolUTF8Entry name, byte[] info) throws IOException {
		this(classFile, classFile.getConstantPool().indexOf(name), info);
	}
	
	public AttributeRuntimeInvisibleAnnotations(ClassFile classFile) throws IOException {
