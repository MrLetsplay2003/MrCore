...
public enum VersionedSound {
	...
	BLOCK_NOTE_BLOCK_BASEDRUM(
			...
			of("BLOCK_NOTE_BLOCK_BASEDRUM", NMSVersion.V1_13_R1)
		),
	BLOCK_NOTE_BLOCK_SNARE(
			...
			of("BLOCK_NOTE_BLOCK_SNARE", NMSVersion.V1_13_R1)
		),
