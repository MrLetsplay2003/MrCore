...
public enum VersionedMaterial {
	...
	WHITE_STAINED_CLAY(
			...
			of(new MaterialDefinition("WHITE_TERRACOTTA", 0), V1_13.versionsTo(V1_16))
		),
	ORANGE_STAINED_CLAY(
			new StainedClayDefinition(VersionedDyeColor.ORANGE),
			of(new MaterialDefinition("STAINED_CLAY", 1), V1_8.versionsTo(V1_12)),
			of(new MaterialDefinition("ORANGE_TERRACOTTA", 0), V1_13.versionsTo(V1_16))
		),
	MAGENTA_STAINED_CLAY(
			...
			of(new MaterialDefinition("MAGENTA_TERRACOTTA", 0), V1_13.versionsTo(V1_16))
		),
	...
	WHITE_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("WHITE_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_16))
		),
	ORANGE_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("ORANGE_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_16))
		),
	MAGENTA_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("MAGENTA_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_16))
		),
	LIGHT_BLUE_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("LIGHT_BLUE_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_16))
		),
	YELLOW_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("YELLOW_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_16))
		),
	LIME_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("LIME_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_16))
		),
	PINK_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("PINK_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_16))
		),
	GRAY_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("GRAY_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_16))
		),
	LIGHT_GRAY_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("LIGHT_GRAY_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_16))
		),
	CYAN_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("CYAN_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_16))
		),
	PURPLE_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("PURPLE_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_16))
		),
	BLUE_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("BLUE_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_16))
		),
	BROWN_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("BROWN_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_16))
		),
	GREEN_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("GREEN_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_16))
		),
	RED_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("RED_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_16))
		),
	...
	MUSIC_DISC_STRAD(
			...
			of(new MaterialDefinition("MUSIC_DISC_STRAD"), V1_13.versionsTo(V1_16))
		),
	MUSIC_DISC_WARD(
			of(new MaterialDefinition("RECORD_10"), V1_8.versionsTo(V1_12)),
			of(new MaterialDefinition("MUSIC_DISC_WARD"), V1_13.versionsTo(V1_16))
		),
	MUSIC_DISC_11(
			of(new MaterialDefinition("RECORD_11"), V1_8.versionsTo(V1_12)),
			of(new MaterialDefinition("MUSIC_DISC_11"), V1_13.versionsTo(V1_16))
		),
	MUSIC_DISC_WAIT(
			of(new MaterialDefinition("RECORD_12"), V1_8.versionsTo(V1_12)),
			of(new MaterialDefinition("MUSIC_DISC_WAIT"), V1_13.versionsTo(V1_16))
		),
	/**
	...
	INK_SACK(
			...
			of(new MaterialDefinition("INK_SAC"), V1_13.versionsTo(V1_16))
		),
	INK_SAC(
			of(new MaterialDefinition("INK_SACK"), V1_8.versionsTo(V1_12)),
			of(new MaterialDefinition("INK_SAC"), V1_13.versionsTo(V1_16))
	...
	BLACK_DYE(
			...
			of(new MaterialDefinition("BLACK_DYE"), V1_14.versionsTo(V1_16))
		),
	/**
	...
	ROSE_RED(
			...
			of(new MaterialDefinition("RED_DYE"), V1_14.versionsTo(V1_16))
		),
	RED_DYE(
			new DyeDefinition(VersionedDyeColor.RED),
			of(new MaterialDefinition("INK_SACK", 1), V1_8.versionsTo(V1_12)),
	...
	CACTUS_GREEN(
			...
			of(new MaterialDefinition("GREEN_DYE"), V1_14.versionsTo(V1_16))
		),
	GREEN_DYE(
			new DyeDefinition(VersionedDyeColor.GREEN),
			of(new MaterialDefinition("INK_SACK", 2), V1_8.versionsTo(V1_12)),
	...
	DANDELION_YELLOW(
			...
			of(new MaterialDefinition("YELLOW_DYE"), V1_14.versionsTo(V1_16))
		),
	YELLOW_DYE(
			new DyeDefinition(VersionedDyeColor.YELLOW),
			of(new MaterialDefinition("INK_SACK", 11), V1_8.versionsTo(V1_12)),
