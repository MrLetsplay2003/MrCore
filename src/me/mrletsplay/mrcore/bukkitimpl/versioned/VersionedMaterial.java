...
public enum VersionedMaterial {
	...
	WHITE_STAINED_CLAY(
			...
			of(new MaterialDefinition("WHITE_TERRACOTTA", 0), V1_13.versionsTo(V1_14))
		),
	ORANGE_STAINED_CLAY(
			new StainedClayDefinition(VersionedDyeColor.ORANGE),
			of(new MaterialDefinition("STAINED_CLAY", 1), V1_8.versionsTo(V1_12)),
			of(new MaterialDefinition("ORANGE_TERRACOTTA", 0), V1_13.versionsTo(V1_14))
		),
	MAGENTA_STAINED_CLAY(
			...
			of(new MaterialDefinition("MAGENTA_TERRACOTTA", 0), V1_13.versionsTo(V1_14))
		),
	...
	WHITE_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("WHITE_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_14))
		),
	ORANGE_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("ORANGE_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_14))
		),
	MAGENTA_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("MAGENTA_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_14))
		),
	LIGHT_BLUE_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("LIGHT_BLUE_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_14))
		),
	YELLOW_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("YELLOW_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_14))
		),
	LIME_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("LIME_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_14))
		),
	PINK_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("PINK_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_14))
		),
	GRAY_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("GRAY_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_14))
		),
	LIGHT_GRAY_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("LIGHT_GRAY_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_14))
		),
	CYAN_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("CYAN_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_14))
		),
	PURPLE_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("PURPLE_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_14))
		),
	BLUE_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("BLUE_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_14))
		),
	BROWN_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("BROWN_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_14))
		),
	GREEN_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("GREEN_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_14))
		),
	RED_STAINED_GLASS_PANE(
			...
			of(new MaterialDefinition("RED_STAINED_GLASS_PANE", 0), V1_13.versionsTo(V1_14))
		),
	...
	ZOMBIE_HEAD(
			...
			of(new MaterialDefinition("ZOMBIE_HEAD"), V1_13.versionsTo(V1_14))
		),
	PLAYER_HEAD(
			of(new MaterialDefinition("SKULL_ITEM", 3), V1_8.versionsTo(V1_12)),
			of(new MaterialDefinition("PLAYER_HEAD"), V1_13.versionsTo(V1_14))
		),
	CREEPER_HEAD(
			of(new MaterialDefinition("SKULL_ITEM", 4), V1_8.versionsTo(V1_12)),
			of(new MaterialDefinition("CREEPER_HEAD"), V1_13.versionsTo(V1_14))
		),
	DRAGON_HEAD(
			of(new MaterialDefinition("SKULL_ITEM", 5), V1_9.versionsTo(V1_12)),
			of(new MaterialDefinition("DRAGON_HEAD"), V1_13.versionsTo(V1_14))
		),
	COMMAND_BLOCK(
			of(new MaterialDefinition("COMMAND"), V1_8.versionsTo(V1_12)),
			of(new MaterialDefinition("COMMAND_BLOCK"), V1_13.versionsTo(V1_14))
		),
	GRASS(
			of(new MaterialDefinition("LONG_GRASS"), V1_8.versionsTo(V1_12)),
			of(new MaterialDefinition("GRASS"), V1_13.versionsTo(V1_14))
		),
	GRASS_BLOCK(
			of(new MaterialDefinition("GRASS"), V1_8.versionsTo(V1_12)),
			of(new MaterialDefinition("GRASS_BLOCK"), V1_13.versionsTo(V1_14))
		)
	;
